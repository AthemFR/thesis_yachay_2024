...
import renormalization as r

reload(r)

#Function to solve the Dyson Equation based on Green Functions

def green_matrix(energy, gamma_parameter, H, sites, polarization_left, polarization_right):
    ...
    M = r.hamiltonian_ren(H, sites, energy)
...
def Transmission(energy_array, gamma_parameter, H, sites,  polarization_left, polarization_right):
