#Previous version:
#The gamma and polarization parameters are used for the Sigma Matrix and then
# the definition of the Gamma matrices
##############################################################################
#New update:
# The gamma and polarization parameters are used in the definition of the gamma matrices and then
# the Sigma Matrix is obtained as the half of the summation of the 
# gamma matrices.
...
def green_matrix(energy, gamma_parameter, H, polarization_left, polarization_right):
    ...
    Gamma_right[0][0]= (gamma_parameter/2)*((1+polarization_right))
    Gamma_right[1][1] = (gamma_parameter/2)*((1-polarization_right))
    #print(Gamma_right)
